...
// Fonctions : Classe de tests de la classe de gestion Configuration. 
...
{
    /// <summary>
    /// Classe de tests des méthodes de la classe Configuration.
    /// </summary>
    [TestClass]
    public class ConfigurationTest
    {
        ...
        #region Tests de la classe Configuration.

        /// <summary>
        /// Test de la méthode ToString de la classe Configuration.
        /// </summary>
        [TestMethod()]
        public void ConfigurationToStringTest()
        {
            Configuration target = new Configuration();
            string expected = "Configuration";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "ConfigurationToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe Configuration.
        /// </summary>
        [TestMethod()]
        public void ConfigurationConstructorTest()
        {
            Configuration target = new Configuration();
            Assert.IsNotNull(target, "ConfigurationConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="ConfigurationTest"/>.	
        /// </summary>
        public ConfigurationTest()
        {
            // TODO: Constructeur de la classe Configuration
        }
