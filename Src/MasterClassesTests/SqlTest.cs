...
namespace Master.Classes.SqlTest
{
    /// <summary>
    /// Classe de tests des méthodes de la classe Sql.
    /// </summary>
    [TestClass]
    public class Sql
    {
        ...
        #region Tests de la classe Sql.

        /// <summary>
        /// Test de la méthode ToString de la classe Sql.
        /// </summary>
        [TestMethod()]
        public void SqlToStringTest()
        {
            Sql target = new Sql();
            string expected = "Master.Classes.SqlTest.Sql";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "SqlToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe Sql.
        /// </summary>
        [TestMethod()]
        public void SqlConstructorTest()
        {
            Sql target = new Sql();
            Assert.IsNotNull(target, "SqlConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="Sql"/>.	
        /// </summary>
        public Sql()
        {
            // TODO: Constructeur de la classe Sql
        }
