...
namespace Master.Classes.DiversTestTest
{
    /// <summary>
    /// Classe de tests des méthodes de la classe DiversTest.
    /// </summary>
    [TestClass]
    public class DiversTest
    {
        ...
        #region Tests de la classe DiversTest.

        /// <summary>
        /// Test de la méthode ToString de la classe DiversTest.
        /// </summary>
        [TestMethod()]
        public void DiversTestToStringTest()
        {
            DiversTest target = new DiversTest();
            string expected = "Master.Classes.DiversTestTest.DiversTest";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "DiversTestToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe DiversTest.
        /// </summary>
        [TestMethod()]
        public void DiversTestConstructorTest()
        {
            DiversTest target = new DiversTest();
            Assert.IsNotNull(target, "DiversTestConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="DiversTest"/>.	
        /// </summary>
        public DiversTest()
        {
            // TODO: Constructeur de la classe DiversTest
        }
