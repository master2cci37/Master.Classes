...
namespace Master.Classes.SqLiteTest
{
    /// <summary>
    /// Classe de tests des méthodes de la classe SqLite.
    /// </summary>
    [TestClass]
    public class SqLite
    {
        ...
        #region Tests de la classe SqLite.

        /// <summary>
        /// Test de la méthode ToString de la classe SqLite.
        /// </summary>
        [TestMethod()]
        public void SqLiteToStringTest()
        {
            SqLite target = new SqLite();
            string expected = "Master.Classes.SqLiteTest.SqLite";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "SqLiteToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe SqLite.
        /// </summary>
        [TestMethod()]
        public void SqLiteConstructorTest()
        {
            SqLite target = new SqLite();
            Assert.IsNotNull(target, "SqLiteConstructorTest");
        }
        ...
        public SqLite()
        {
            // TODO: Constructeur de la classe SqLite
        }
