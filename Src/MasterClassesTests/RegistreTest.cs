...
// Classe : Registre 
// Fonctions : Classe de tests de la classe de gestion de la base de registre 
...
namespace Master.Classes.RegistreTest
{
    /// <summary>
    /// Classe de tests des méthodes de la classe Registre.
    /// </summary>
    [TestClass]
    public class Registre
    {
        ...
        #region Tests de la classe Registre.

        /// <summary>
        /// Test de la méthode ToString de la classe Registre.
        /// </summary>
        [TestMethod()]
        public void RegistreToStringTest()
        {
            Registre target = new Registre();
            string expected = "Master.Classes.RegistreTest.Registre";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "RegistreToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe Registre.
        /// </summary>
        [TestMethod()]
        public void RegistreConstructorTest()
        {
            Registre target = new Registre();
            Assert.IsNotNull(target, "RegistreConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="Registre"/>.	
        /// </summary>
        public Registre()
        {
            // TODO: Constructeur de la classe Registre
        }
