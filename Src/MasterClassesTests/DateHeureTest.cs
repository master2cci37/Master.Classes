...
// Classe : DateHeureTest 
// Fonctions : Classe de tests de la classe de gestion xxx 
...
namespace Master.Classes.DateHeureTestTest
{
    /// <summary>
    /// Classe de tests des méthodes de la classe DateHeureTest.
    /// </summary>
    [TestClass]
    public class DateHeureTest
    {
        ...
        #region Tests de la classe DateHeureTest.

        /// <summary>
        /// Test de la méthode ToString de la classe DateHeureTest.
        /// </summary>
        [TestMethod()]
        public void DateHeureTestToStringTest()
        {
            DateHeureTest target = new DateHeureTest();
            string expected = "Master.Classes.DateHeureTestTest.DateHeureTest";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "DateHeureTestToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe DateHeureTest.
        /// </summary>
        [TestMethod()]
        public void DateHeureTestConstructorTest()
        {
            DateHeureTest target = new DateHeureTest();
            Assert.IsNotNull(target, "DateHeureTestConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="DateHeureTest"/>.	
        /// </summary>
        public DateHeureTest()
        {
            // TODO: Constructeur de la classe DateHeureTest
        }
