...
// Classe : Reseau 
// Fonctions : Classe de tests de la classe de gestion des reseaux 
...
namespace Master.Classes.ReseauTest
{
    /// <summary>
    /// Classe de tests des méthodes de la classe Reseau.
    /// </summary>
    [TestClass]
    public class Reseau
    {
        ...
        #region Tests de la classe Reseau.

        /// <summary>
        /// Test de la méthode ToString de la classe Reseau.
        /// </summary>
        [TestMethod()]
        public void ReseauToStringTest()
        {
            Reseau target = new Reseau();
            string expected = "Master.Classes.ReseauTest.Reseau";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "ReseauToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe Reseau.
        /// </summary>
        [TestMethod()]
        public void ReseauConstructorTest()
        {
            Reseau target = new Reseau();
            Assert.IsNotNull(target, "ReseauConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="Reseau"/>.	
        /// </summary>
        public Reseau()
        {
            // TODO: Constructeur de la classe Reseau
        }
