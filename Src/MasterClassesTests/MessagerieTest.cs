...
// Classe : MessagerieTest 
// Fonctions : Classe de tests de la classe de gestion Messagerie. 
...
namespace Master.Classes.Reseau
{
    /// <summary>
    /// Classe de tests des méthodes de la classe Messagerie.
    /// </summary>
    [TestClass]
    public class MessagerieTest
    {
        ...
        #region Tests de la classe Messagerie.

        /// <summary>
        /// Test de la méthode ToString de la classe Messagerie.
        /// </summary>
        [TestMethod()]
        public void MessagerieToStringTest()
        {
            Messagerie target = new Messagerie();
            string expected = "Messagerie";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "MessagerieToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe Messagerie.
        /// </summary>
        [TestMethod()]
        public void MessagerieConstructorTest()
        {
            Messagerie target = new Messagerie();
            Assert.IsNotNull(target, "MessagerieConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="MessagerieTest"/>.	
        /// </summary>
        public MessagerieTest()
        {
            // TODO: Constructeur de la classe Messagerie
        }
