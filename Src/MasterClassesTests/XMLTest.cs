...
// Classe : Xml 
// Fonctions : Classe de tests de la classe de gestion Xml 
...
namespace Master.Classes.Xml 
{
    /// <summary>
    /// Classe de tests des méthodes de la classe Xml.
    /// </summary>
    [TestClass]
    public class XmlTest
    {
        ...
        #region Tests de la classe Xml. 

        /// <summary>
        /// Test de la méthode ToString de la classe Xml.
        /// </summary>
        [TestMethod()]
        public void XmlToStringTest()
        {
            Xml target = new Xml();
            string expected = "Master.Classes.XmlTest.Xml";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "XmlToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe Xml.
        /// </summary>
        [TestMethod()]
        public void XmlConstructorTest()
        {
            Xml target = new Xml();
            Assert.IsNotNull(target, "XmlConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="Xml"/>.	
        /// </summary>
        public XmlTest()
        {
            // TODO: Constructeur de la classe Xml
        }
