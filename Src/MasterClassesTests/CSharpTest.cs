...
namespace Master.Classes.CSharpTestTest
{
    /// <summary>
    /// Classe de tests des méthodes de la classe CSharpTest.
    /// </summary>
    [TestClass]
    public class CSharpTest
    {
        ...
        #region Tests de la classe CSharpTest.

        /// <summary>
        /// Test de la méthode ToString de la classe CSharpTest.
        /// </summary>
        [TestMethod()]
        public void CSharpTestToStringTest()
        {
            CSharpTest target = new CSharpTest();
            string expected = "Master.Classes.CSharpTestTest.CSharpTest";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "CSharpTestToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe CSharpTest.
        /// </summary>
        [TestMethod()]
        public void CSharpTestConstructorTest()
        {
            CSharpTest target = new CSharpTest();
            Assert.IsNotNull(target, "CSharpTestConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="CSharpTest"/>.	
        /// </summary>
        public CSharpTest()
        {
            // TODO: Constructeur de la classe CSharpTest
        }
