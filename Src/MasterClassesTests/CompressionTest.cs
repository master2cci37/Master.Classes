...
// Classe : Compression 
// Fonctions : Classe de tests de la classe de gestion des Compressions de fichiers 
...
namespace Master.Classes.CompressionTest
{
    /// <summary>
    /// Classe de tests des méthodes de la classe Compression.
    /// </summary>
    [TestClass]
    public class Compression
    {
        ...
        #region Tests de la classe Compression.

        /// <summary>
        /// Test de la méthode ToString de la classe Compression.
        /// </summary>
        [TestMethod()]
        public void CompressionToStringTest()
        {
            Compression target = new Compression();
            string expected = "Master.Classes.CompressionTest.Compression";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "CompressionToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe Compression.
        /// </summary>
        [TestMethod()]
        public void CompressionConstructorTest()
        {
            Compression target = new Compression();
            Assert.IsNotNull(target, "CompressionConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="Compression"/>.	
        /// </summary>
        public Compression()
        {
            // TODO: Constructeur de la classe Compression
        }
