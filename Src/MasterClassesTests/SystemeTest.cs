...
// Classe : Systeme 
// Fonctions : Classe de tests de la classe de gestion Systeme 
...
namespace Master.Classes.SystemeTest
{
    /// <summary>
    /// Classe de tests des méthodes de la classe Systeme.
    /// </summary>
    [TestClass]
    public class Systeme
    {
        ...
        #region Tests de la classe Systeme.

        /// <summary>
        /// Test de la méthode ToString de la classe Systeme.
        /// </summary>
        [TestMethod()]
        public void SystemeToStringTest()
        {
            Systeme target = new Systeme();
            string expected = "Master.Classes.SystemeTest.Systeme";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "SystemeToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe Systeme.
        /// </summary>
        [TestMethod()]
        public void SystemeConstructorTest()
        {
            Systeme target = new Systeme();
            Assert.IsNotNull(target, "SystemeConstructorTest");
        }
