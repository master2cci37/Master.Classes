...
// Classe : FichiersTest 
// Fonctions : Classe de tests de la classe de gestion Fichiers. 
...
{
    /// <summary>
    /// Classe de tests des méthodes de la classe Fichiers.
    /// </summary>
    [TestClass]
    public class FichiersTest
    {
        ...
        #region Tests de la classe Fichiers.

        /// <summary>
        /// Test de la méthode ToString de la classe Fichiers.
        /// </summary>
        [TestMethod()]
        public void FichiersToStringTest()
        {
            Fichiers target = new Fichiers();
            string expected = "Fichiers";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "FichiersToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe Fichiers.
        /// </summary>
        [TestMethod()]
        public void FichiersConstructorTest()
        {
            Fichiers target = new Fichiers();
            Assert.IsNotNull(target, "FichiersConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="FichiersTest"/>.	
        /// </summary>
        public FichiersTest()
        {
            // TODO: Constructeur de la classe Fichiers
        }
