...
// Classe : CryptageTest 
// Fonctions : Classe de tests de la classe de gestion Cryptage. 
...
namespace Master.Classes.Securite
{
    /// <summary>
    /// Classe de tests des méthodes de la classe Cryptage.
    /// </summary>
    [TestClass]
    public class CryptageTest
    {
        ...
        #region Tests de la classe Cryptage.

        /// <summary>
        /// Test de la méthode ToString de la classe Cryptage.
        /// </summary>
        [TestMethod()]
        ...
        /// <summary>
        /// Test du constructeur sans paramètre de la classe Cryptage.
        /// </summary>
        [TestMethod()]
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="CryptageTest"/>.	
        /// </summary>
        public CryptageTest()
        {
            // TODO: Constructeur de la classe Cryptage
        }
