...
// Classe : AlgorithmeTest 
// Fonctions : Classe de tests de la classe de gestion Algorithme. 
...
{
    /// <summary>
    /// Classe de tests des méthodes de la classe Algorithme.
    /// </summary>
    [TestClass]
    public class AlgorithmeTest
    {
        ...
        #region Tests de la classe Algorithme.

        /// <summary>
        /// Test de la méthode ToString de la classe Algorithme.
        /// </summary>
        [TestMethod()]
        public void AlgorithmeToStringTest()
        {
            Algorithme target = new Algorithme();
            string expected = "Algorithme";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "AlgorithmeToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe Algorithme.
        /// </summary>
        [TestMethod()]
        public void AlgorithmeConstructorTest()
        {
            Algorithme target = new Algorithme();
            Assert.IsNotNull(target, "AlgorithmeConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="AlgorithmeTest"/>.	
        /// </summary>
        public AlgorithmeTest()
        {
            // TODO: Constructeur de la classe Algorithme
        }
