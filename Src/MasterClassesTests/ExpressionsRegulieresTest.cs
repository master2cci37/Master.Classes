...
// Classe : ExpressionsRegulieres 
// Fonctions : Classe de tests de la classe de gestion des ExpressionsRegulieres 
...
namespace Master.Classes.ExpressionsRegulieresTest
{
    /// <summary>
    /// Classe de tests des méthodes de la classe ExpressionsRegulieres.
    /// </summary>
    [TestClass]
    public class ExpressionsRegulieres
    {
        ...
        #region Tests de la classe ExpressionsRegulieres.

        /// <summary>
        /// Test de la méthode ToString de la classe ExpressionsRegulieres.
        /// </summary>
        [TestMethod()]
        public void ExpressionsRegulieresToStringTest()
        {
            ExpressionsRegulieres target = new ExpressionsRegulieres();
            string expected = "Master.Classes.ExpressionsRegulieresTest.ExpressionsRegulieres";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "ExpressionsRegulieresToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe ExpressionsRegulieres.
        /// </summary>
        [TestMethod()]
        public void ExpressionsRegulieresConstructorTest()
        {
            ExpressionsRegulieres target = new ExpressionsRegulieres();
            Assert.IsNotNull(target, "ExpressionsRegulieresConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="ExpressionsRegulieres"/>.	
        /// </summary>
        public ExpressionsRegulieres()
        {
            // TODO: Constructeur de la classe ExpressionsRegulieres
        }
