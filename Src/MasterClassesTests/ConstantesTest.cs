...
// Classe : ConstantesTest 
// Fonctions : Classe de tests de la classe de gestion Constantes. 
...
using System.Linq;
using System.Text;
using Master.Classes.Constantes;
...
namespace Master.Classes.Constantes
{
    /// <summary>
    /// Classe de tests des méthodes de la classe Constantes.
    /// </summary>
    [TestClass]
    public class ConstantesTest
    {
        ...
        #region Tests de la classe Constantes.

        /// <summary>
        /// Test de la méthode ToString de la classe Constantes.
        /// </summary>
        [TestMethod()]
        public void ConstantesToStringTest()
        {
            Constantes target = new Constantes();
            string expected = "Constantes";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "ConstantesToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe Constantes.
        /// </summary>
        [TestMethod()]
        public void ConstantesConstructorTest()
        {
            Constantes target = new Constantes();
            Assert.IsNotNull(target, "ConstantesConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="ConstantesTest"/>.	
        /// </summary>
        public ConstantesTest()
        {
            // TODO: Constructeur de la classe Constantes
        }
