...
// Classe : Chaine 
// Fonctions : Classe de tests de la classe de gestion des Chaines 
...
using System.Linq;
using System.Text;
using ClasseChaine = Master.Classes.Chaine;
...
namespace Master.Classes.ChaineTest
{
    /// <summary>
    /// Classe de tests des méthodes de la classe Chaine.
    /// </summary>
    [TestClass]
    public class ChaineTest
    {
        ...
        #region Tests de la classe Chaine.

        /// <summary>
        /// Test de la méthode RetourneChaineRaccourcie de la classe Chaine.
        /// Moins de 8 caractères.
        /// </summary>
        [TestMethod()]
        public void RetourneChaineRaccourcieLongueurSept()
        {
            ClasseChaine.Chaine target = new ClasseChaine.Chaine();
            string expected = "Méthode";
            string actual;
            actual = target.RetourneChaineRaccourcie("Méthode");
            Assert.AreEqual(expected, actual, "RetourneChaineRaccourcieLongueurSept");
        }
        ...
        /// </summary>
        [TestMethod()]
        public void RetourneChaineRaccourcieLongueurHuit()
        {
            ClasseChaine.Chaine target = new ClasseChaine.Chaine();
            string expected = "Méth[...]aine";
            string actual;
            actual = target.RetourneChaineRaccourcie("Méthodes de la classe chaine");
            Assert.AreEqual(expected, actual, "RetourneChaineRaccourcieLongueurHuit");
        }

        /// <summary>
        /// Test de la méthode ToString de la classe Chaine.
        /// </summary>
        [TestMethod()]
        public void ChaineToStringTest()
        {
            ClasseChaine.Chaine target = new ClasseChaine.Chaine();
            string expected = "Chaine";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "ChaineToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe Chaine.
        /// </summary>
        [TestMethod()]
        public void ChaineConstructorTest()
        {
            ClasseChaine.Chaine target = new ClasseChaine.Chaine();
            Assert.IsNotNull(target, "ChaineConstructorTest");
        }
