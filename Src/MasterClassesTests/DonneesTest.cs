...
// Classe : Donnees 
// Fonctions : Classe de gestion des Données 
...
namespace Master.Classes.DonneesTest
{
    /// <summary>
    /// Classe de tests des méthodes de la classe Donnees.
    /// </summary>
    [TestClass]
    public class Donnees
    {
        ...
        #region Tests de la classe Donnees.

        /// <summary>
        /// Test de la méthode ToString de la classe Donnees.
        /// </summary>
        [TestMethod()]
        public void DonneesToStringTest()
        {
            Donnees target = new Donnees();
            string expected = "Master.Classes.DonneesTest.Donnees";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "DonneesToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe Donnees.
        /// </summary>
        [TestMethod()]
        public void DonneesConstructorTest()
        {
            Donnees target = new Donnees();
            Assert.IsNotNull(target, "DonneesConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="Donnees"/>.	
        /// </summary>
        public Donnees()
        {
            // TODO: Constructeur de la classe Donnees
        }
