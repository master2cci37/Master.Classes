...
// Classe : APITest 
// Fonctions : Classe de tests de la classe de gestion API. 
...
{
    /// <summary>
    /// Classe de tests des méthodes de la classe API.
    /// </summary>
    [TestClass]
    public class APITest
    {
        ...
        #region Tests de la classe API.

        /// <summary>
        /// Test de la méthode ToString de la classe API.
        /// </summary>
        [TestMethod()]
        public void APIToStringTest()
        {
            API target = new API();
            string expected = "API";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "APIToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe API.
        /// </summary>
        [TestMethod()]
        public void APIConstructorTest()
        {
            API target = new API();
            Assert.IsNotNull(target, "APIConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="APITest"/>.	
        /// </summary>
        public APITest()
        {
            // TODO: Constructeur de la classe API
        }
