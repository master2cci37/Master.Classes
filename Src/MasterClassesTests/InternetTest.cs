...
// Classe : InternetTest 
// Fonctions : Classe de tests de la classe de gestion Internet. 
...
{
    /// <summary>
    /// Classe de tests des méthodes de la classe Internet.
    /// </summary>
    [TestClass]
    public class InternetTest
    {
        ...
        #region Tests de la classe Internet.

        /// <summary>
        /// Test de la méthode ToString de la classe Internet.
        /// </summary>
        [TestMethod()]
        public void InternetToStringTest()
        {
            Internet target = new Internet();
            string expected = "Internet";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "InternetToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe Internet.
        /// </summary>
        [TestMethod()]
        public void InternetConstructorTest()
        {
            Internet target = new Internet();
            Assert.IsNotNull(target, "InternetConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="InternetTest"/>.	
        /// </summary>
        public InternetTest()
        {
            // TODO: Constructeur de la classe Internet
        }
