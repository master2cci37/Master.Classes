...
// Classe : Editions 
// Fonctions : Classe de gestion des Editions 
...
namespace Master.Classes.EditionsTest
{
    /// <summary>
    /// Classe de tests des méthodes de la classe Editions.
    /// </summary>
    [TestClass]
    public class Editions
    {
        ...
        #region Tests de la classe Editions.

        /// <summary>
        /// Test de la méthode ToString de la classe Editions.
        /// </summary>
        [TestMethod()]
        public void EditionsToStringTest()
        {
            Editions target = new Editions();
            string expected = "Master.Classes.EditionsTest.Editions";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "EditionsToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe Editions.
        /// </summary>
        [TestMethod()]
        public void EditionsConstructorTest()
        {
            Editions target = new Editions();
            Assert.IsNotNull(target, "EditionsConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="Editions"/>.	
        /// </summary>
        public Editions()
        {
            // TODO: Constructeur de la classe Editions
        }
