...
// Classe : SqlServer 
// Fonctions : Classe de tests de la classe de gestion Donnees 
...
namespace Master.Classes.SqlServerTest
{
    /// <summary>
    /// Classe de tests des méthodes de la classe SqlServer.
    /// </summary>
    [TestClass]
    public class SqlServer
    {
        ...
        #region Tests de la classe SqlServer.

        /// <summary>
        /// Test de la méthode ToString de la classe SqlServer.
        /// </summary>
        [TestMethod()]
        public void SqlServerToStringTest()
        {
            SqlServer target = new SqlServer();
            string expected = "Master.Classes.SqlServerTest.SqlServer";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "SqlServerToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe SqlServer.
        /// </summary>
        [TestMethod()]
        public void SqlServerConstructorTest()
        {
            SqlServer target = new SqlServer();
            Assert.IsNotNull(target, "SqlServerConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="SqlServer"/>.	
        /// </summary>
        public SqlServer()
        {
            // TODO: Constructeur de la classe SqlServer
        }
