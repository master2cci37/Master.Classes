...
// Classe : DocumentXml 
// Fonctions : Classe de gestion des Documents Xml 
...
namespace Master.Classes.DocumentXmlTest
{
    /// <summary>
    /// Classe de tests des méthodes de la classe DocumentXml.
    /// </summary>
    [TestClass]
    public class DocumentXml
    {
        ...
        #region Tests de la classe DocumentXml.

        /// <summary>
        /// Test de la méthode ToString de la classe DocumentXml.
        /// </summary>
        [TestMethod()]
        public void DocumentXmlToStringTest()
        {
            DocumentXml target = new DocumentXml();
            string expected = "Master.Classes.DocumentXmlTest.DocumentXml";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "DocumentXmlToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe DocumentXml.
        /// </summary>
        [TestMethod()]
        public void DocumentXmlConstructorTest()
        {
            DocumentXml target = new DocumentXml();
            Assert.IsNotNull(target, "DocumentXmlConstructorTest");
        }
        ...
        /// <summary>
        ///	Initialise une nouvelle instance de la classe <see cref="DocumentXml"/>.	
        /// </summary>
        public DocumentXml()
        {
            // TODO: Constructeur de la classe DocumentXml
        }
