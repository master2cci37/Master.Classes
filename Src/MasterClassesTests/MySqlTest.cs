...
// Classe : MySql 
// Fonctions : Classe de tests de la classe de gestion Données 
// License:  License LGPL 
// Version :  0.01 du 11/02/2010 
...
namespace Master.Classes.MySqlTest
{
    /// <summary>
    /// Classe de tests des méthodes de la classe MySql.
    /// </summary>
    [TestClass]
    public class MySql
    {
        ...
        #region Tests de la classe MySql.

        /// <summary>
        /// Test de la méthode ToString de la classe MySql.
        /// </summary>
        [TestMethod()]
        public void MySqlToStringTest()
        {
            MySql target = new MySql();
            string expected = "Master.Classes.MySqlTest.MySql";
            string actual;
            actual = target.ToString();
            Assert.AreEqual(expected, actual, "MySqlToStringTest");
        }

        /// <summary>
        /// Test du constructeur sans paramètre de la classe MySql.
        /// </summary>
        [TestMethod()]
        public void MySqlConstructorTest()
        {
            MySql target = new MySql();
            Assert.IsNotNull(target, "MySqlConstructorTest");
        }
        ...
        public MySql()
        {
            // TODO: Constructeur de la classe MySql
        }
